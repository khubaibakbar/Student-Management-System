...
namespace CA1
{
    public partial class AddStudent : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            db.con.Open();
            String query = "insert into student (studentNumber,name,address,county,age,phone,email,gender) values (@studentNumber,@name,@address,@county,@age,@phone,@email,@gender)";
